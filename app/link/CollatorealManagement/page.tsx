        ...
        <div className="min-h-screen w-full px-6 pt-[9rem] pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto items-center">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
              <p>
                Our Collateral Management System enables financial institutions
                to track, evaluate, and secure collateral assets with complete
                transparency. It enhances compliance, reduces risk exposure, and
                ensures full lifecycle monitoring for every pledged asset.
              </p>

              <ul className="space-y-4 font-semibold">
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Real-Time Asset Monitoring & Tracking
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Automated Valuation & Risk Assessment
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Regulatory Compliance & Secure Documentation
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Alerts for Expiry, Damage & Ownership Changes
                </li>
              </ul>
            ...
            <div className="flex justify-center">
              <div className="flex justify-center w-full">
                <Image
                  src="/assests/picturesofcards/collateral_mangemnet.jpg"
