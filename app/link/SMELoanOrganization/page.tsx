      ...
      <div className="min-h-screen w-full px-6 pt-[9rem] pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto items-center">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
            <p>
              SME Loan Origination system chhoti aur medium businesses ke liye
              loan process ko speedy aur automated banata hai. Documentation se
              le kar approval tak — sab kuch seamless workflow ke through hota
              hai.
            </p>
