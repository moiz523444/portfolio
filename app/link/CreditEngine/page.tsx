        ...
        <div className="min-h-screen w-full px-6 pt-[9rem] pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto items-center">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
              <p>
                Our intelligent Credit Engine empowers lenders with advanced
                risk scoring, data-driven decisioning, and automated approval
                workflows. It enhances the credit lifecycle by improving
                accuracy, reducing manual effort, and enabling faster loan
                approvals with greater confidence.
              </p>

              <ul className="space-y-4 font-semibold">
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  AI-Powered Risk Scoring & Assessment
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                ...
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Accurate Loan Eligibility Evaluation
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-500 font-bold">✔</span>
                  Smart & Configurable Rules Engine
                </li>
              </ul>
